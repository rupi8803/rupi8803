...
import { e as ProtocolError, T as TimeoutWaitingForResponseErrorCode, f as utf8ToBytes, E as ExternalError, g as MissingRootKeyErrorCode, h as Certificate, l as lookupResultToBuffer, i as RequestStatusResponseStatus, U as UnknownError, k as RequestStatusDoneNoReplyErrorCode, m as RejectError, n as CertifiedRejectErrorCode, o as UNREACHABLE_ERROR, I as InputError, q as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, D as isV2ResponseBody, F as UncertifiedRejectUpdateErrorCode, G as UnexpectedErrorCode, J as decode, S as Subscribable, K as pendingThenable, N as resolveEnabled, O as shallowEqualObjects, V as resolveStaleTime, W as noop$1, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, r as reactExports, a4 as shouldThrowError, a5 as useQueryClient, a6 as useInternetIdentity, a7 as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, a as cn, a8 as reactDomExports, u as useComposedRefs, b as ChevronDown, a9 as Record, aa as Variant, ab as Service, ac as Func, ad as Vec, ae as Text, af as Int, ag as Nat } from "./index-j41ECiun.js";
import { P as Primitive } from "./separator-CJ24PL1W.js";
import { P as Primitive$1, f as useLayoutEffect2, b as createContextScope, u as useControllableState, a as useId, c as composeEventHandlers, d as createSlot } from "./index-BInmXSKi.js";
import { u as useDirection, c as createCollection } from "./index-DYUvcgkr.js";
import { a as useCallbackRef, P as Portal$1, h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-DxK8ZWd5.js";
import { C as ChevronUp } from "./chevron-up-D0xpNk48.js";
...
const Timestamp = Int;
const ConsultationBooking = Record({
  "id": Nat,
  "name": Text,
...
const ConsultationBookingInput = Record({
  "name": Text,
  "email": Text,
  "preferredDateTime": Text,
  "notes": Text,
...
const ITAuditRequestInput = Record({
  "contactName": Text,
  "itChallenges": Text,
  "preferredAuditDate": Text,
  "email": Text,
...
Service({
  "getConsultationBookings": Func(
    [],
    [Vec(ConsultationBooking)],
    ["query"]
  ),
  ...
  "getITAuditRequests": Func([], [Vec(ITAuditRequest)], ["query"]),
  "submitConsultationBooking": Func(
    [ConsultationBookingInput],
    [Result],
    []
  ),
  "submitContactForm": Func([ContactFormInput], [Result], []),
  "submitITAuditRequest": Func([ITAuditRequestInput], [Result], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const Timestamp2 = IDL2.Int;
  const ConsultationBooking2 = IDL2.Record({
    "id": IDL2.Nat,
    "name": IDL2.Text,
    "submittedAt": Timestamp2,
    "email": IDL2.Text,
    "preferredDateTime": IDL2.Text,
    "notes": IDL2.Text,
    "phone": IDL2.Text
  });
  const ContactSubmission2 = IDL2.Record({
    ...
    "submittedAt": Timestamp2,
    "email": IDL2.Text,
    "serviceInterest": IDL2.Text,
    "message": IDL2.Text,
    "phone": IDL2.Text
  });
  const ITAuditRequest2 = IDL2.Record({
    "id": IDL2.Nat,
    "contactName": IDL2.Text,
    "itChallenges": IDL2.Text,
    "preferredAuditDate": IDL2.Text,
    "submittedAt": Timestamp2,
    "email": IDL2.Text,
  ...
  const ConsultationBookingInput2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "preferredDateTime": IDL2.Text,
    "notes": IDL2.Text,
  ...
  const ContactFormInput2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "serviceInterest": IDL2.Text,
    "message": IDL2.Text,
  ...
  const ITAuditRequestInput2 = IDL2.Record({
    "contactName": IDL2.Text,
    "itChallenges": IDL2.Text,
    "preferredAuditDate": IDL2.Text,
    "email": IDL2.Text,
  ...
  return IDL2.Service({
    "getConsultationBookings": IDL2.Func(
      [],
      [IDL2.Vec(ConsultationBooking2)],
      ["query"]
    ),
    ...
    "getITAuditRequests": IDL2.Func([], [IDL2.Vec(ITAuditRequest2)], ["query"]),
    "submitConsultationBooking": IDL2.Func(
      [ConsultationBookingInput2],
      [Result2],
      []
    ),
    "submitContactForm": IDL2.Func([ContactFormInput2], [Result2], []),
    "submitITAuditRequest": IDL2.Func([ITAuditRequestInput2], [Result2], [])
  });
};
class Backend {
  ...
  async submitConsultationBooking(arg0) {
    if (this.processError) {
      try {
  ...
  async submitITAuditRequest(arg0) {
    if (this.processError) {
      try {
