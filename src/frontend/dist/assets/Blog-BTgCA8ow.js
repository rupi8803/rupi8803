import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, C as Clock, L as Link } from "./index-C_4JYRI7.js";
...
const BLOG_POSTS = [
  {
    ...
    excerpt: "In 2025, your website is often the first impression a potential customer has of your business. A professional, fast-loading site builds trust and drives sales — a DIY template often does the opposite.",
    date: "14 April 2026",
    category: "Web Design",
    readTime: "5 min read",
    relatedIds: [3, 8, 2],
  ...
  },
  {
    ...
    excerpt: "Slow computers, frequent crashes, security vulnerabilities — these aren't just annoyances. They're warning signs that your IT infrastructure is holding your business back and putting your data at risk.",
    date: "1 April 2026",
    category: "IT Tips",
    readTime: "6 min read",
    relatedIds: [5, 9, 6],
  ...
  },
  {
    ...
    excerpt: "Choosing the wrong platform for your website can cost you time and money down the track. We break down the key differences between Shopify and WordPress to help you make the right call for your business.",
    date: "20 March 2026",
    category: "Web Design",
    readTime: "7 min read",
    relatedIds: [1, 8, 7],
  ...
  },
  {
    ...
    excerpt: "Plumbers, electricians, and builders who embrace simple digital tools — a good website, online booking, and job management software — are winning more work and running more efficient businesses.",
    date: "8 March 2026",
  ...
  },
  {
    ...
    excerpt: "Managed IT services replace the break-fix model with proactive, ongoing support for a fixed monthly fee. For most small businesses, it's a smarter and more cost-effective approach to technology management.",
  ...
  },
  {
    ...
    excerpt: "A single data loss event — whether from ransomware, hardware failure, or human error — can cost a small business tens of thousands of dollars and weeks of recovery time. Most businesses are far less protected than they think.",
  ...
  },
  {
    ...
    excerpt: "Modern POS systems do far more than process payments. From inventory management to customer loyalty programs, choosing the right POS can transform how your retail or hospitality business operates.",
  ...
  },
  {
    ...
    excerpt: "With dozens of website platforms available — WordPress, Shopify, Wix, Squarespace, and more — it can be hard to know where to start. This guide cuts through the noise to help you make the right choice for your business.",
  ...
  },
  {
    ...
    excerpt: "Cyber attacks on small Australian businesses are increasing every year. These practical, affordable security steps can dramatically reduce your risk — without needing a dedicated IT security team.",
    date: "3 January 2026",
    category: "IT Tips",
    readTime: "7 min read",
    relatedIds: [2, 6, 5],
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/15 text-accent border-0 text-xs w-fit mb-3", children: post.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg leading-snug mb-3 group-hover:text-primary transition-colors", children: post.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed flex-1 mb-4", children: post.excerpt }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between pt-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground", children: [
...
function BlogModal({
  ...
  if (!post) return null;
  const related = post.relatedIds.map((id) => allPosts.find((p) => p.id === id)).filter((p) => Boolean(p)).slice(0, 3);
  function copyLink() {
    const url = `${window.location.origin}/blog#${post == null ? void 0 : post.slug}`;
    navigator.clipboard.writeText(url).then(() => {
      ue.success("Link copied to clipboard!");
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!post, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/15 text-accent border-0 text-xs w-fit mb-2", children: post.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-xl text-foreground leading-snug", children: post.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3.5 h-3.5" }),
              post.date
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 text-sm text-muted-foreground leading-relaxed", children: post.body.map((paragraph) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: paragraph }, paragraph.slice(0, 40))) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Share this article" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
        ...
        related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-3 text-sm", children: "Related Articles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: related.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: () => onOpen(r),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/10 text-accent border-0 text-xs shrink-0 mt-0.5", children: r.category }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground group-hover:text-primary transition-colors font-medium leading-snug", children: r.title })
                ]
              },
              r.id
            )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Need Help?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Talk to our experts about your IT or web needs." })
          ] }),
...
function BlogPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background", "data-ocid": "blog.posts_section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: CATEGORY_TABS.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setActiveCategory(cat),
                "data-ocid": `blog.filter.${cat.toLowerCase().replace(/\s+/g, "_")}`,
                className: `px-4 py-2 rounded-full text-sm font-medium transition-smooth border ${activeCategory === cat ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-foreground border-border hover:border-primary/40 hover:text-primary"}`,
                children: cat
              },
              cat
            ))
      ...
      filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: filtered.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        BlogCard,
        {
          post,
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium", children: "No articles found" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Try a different search term or category." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-label text-primary block mb-3", children: "Need Expert Help?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-foreground text-2xl md:text-3xl mb-3", children: "Don't Just Read About It — Get Personalised Advice" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Our IT and web experts are ready to help you take action on what you've learned." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CTAButton,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 100, direction: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-6 shadow-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4", children: "Related Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
              ...
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-3.5 h-3.5 text-muted-foreground group-hover:text-primary transition-colors shrink-0" }),
                  link.label
                ]
              }
            ) }, link.href)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary py-16", "data-ocid": "blog.cta_banner", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-primary-foreground text-3xl mb-4", children: "Need Expert IT Advice for Your Business?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg max-w-xl mx-auto mb-8", children: "Don't just read about it — get personalised IT guidance from our certified experts." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CTAButton,
        {
