...
const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.48 0.18 240) 0%, oklch(0.60 0.14 200) 100%)",
    icon: <Globe className="w-10 h-10 text-white" />,
    fullDescription:
      "A local plumbing business in Melbourne was relying entirely on word-of-mouth and an outdated website from 2015. Potential customers couldn't find them on Google, and the site wasn't mobile-friendly.",
    challenge:
      "The business had no digital presence worth speaking of. Their existing site scored 32/100 on Google PageSpeed and had zero local SEO optimisation.",
    solution:
      "We built a modern, mobile-first WordPress website with local SEO setup, Google Business Profile integration, a clear call-to-action on every page, and a click-to-call button. The site was live in under two weeks.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.52 0.22 310) 0%, oklch(0.62 0.18 285) 100%)",
    icon: <Globe className="w-10 h-10 text-white" />,
    fullDescription:
      "A boutique clothing store in Sydney had been selling exclusively in-store. With foot traffic declining, the owner wanted to expand online but wasn't sure where to start.",
    challenge:
      "No existing e-commerce infrastructure, limited digital marketing experience, and a need to maintain brand aesthetics online.",
    solution:
      "We designed and launched a fully branded Shopify store, integrated with their existing POS system for real-time inventory sync. We added abandoned cart recovery, product recommendations, and Instagram Shop integration.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.50 0.14 162) 0%, oklch(0.62 0.12 185) 100%)",
    icon: <Shield className="w-10 h-10 text-white" />,
    fullDescription:
      "A busy GP practice with 8 doctors and 15 staff was spending hours every week dealing with IT problems — slow computers, printer failures, and software crashes during patient appointments.",
    challenge:
      "Constant reactive IT problems were disrupting patient care. The practice had no formal IT management, relied on a single part-time IT person, and had critical compliance gaps.",
    solution:
      "We onboarded the practice onto our Managed IT Professional plan. This included 24/7 monitoring, automated patching, endpoint security, secure backup, and a dedicated support line for staff.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.64 0.17 55) 0%, oklch(0.70 0.15 35) 100%)",
    icon: <CreditCard className="w-10 h-10 text-white" />,
    fullDescription:
      "A popular café in Brisbane was running on an outdated cash register system that couldn't handle split bills, table management, or kitchen display orders — causing queues and errors during peak hours.",
    challenge:
      "The existing system couldn't integrate with their accounting software, had no reporting capability, and required manual end-of-day reconciliation taking 45 minutes per night.",
    solution:
      "We deployed a modern cloud-based POS system with kitchen display screens, table management, split-billing, and direct Xero integration. Full setup and staff training completed in a single day.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.52 0.20 25) 0%, oklch(0.60 0.17 10) 100%)",
    icon: <HardDrive className="w-10 h-10 text-white" />,
    fullDescription:
      "A family-owned hardware store in Adelaide was hit by a ransomware attack on a Tuesday morning. Their entire system — accounting, inventory, and supplier database — was encrypted.",
    challenge:
      "The attack threatened to destroy 12 years of business data. Without backups, they faced weeks of reconstruction and potentially tens of thousands of dollars in recovery costs.",
    solution:
      "Fortunately, we had implemented a 3-2-1 backup strategy for this client 8 months prior. We restored all systems from the most recent clean backup, quarantined the infected devices, and had them operational the same day.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.46 0.18 230) 0%, oklch(0.58 0.15 250) 100%)",
    icon: <Wrench className="w-10 h-10 text-white" />,
    fullDescription:
      "A dental practice in Melbourne had experienced two website outages in one year, causing patient booking disruptions. They needed reliable ongoing maintenance to keep their online presence working.",
    challenge:
      "Their WordPress site was running outdated plugins, had no security monitoring, and regular updates were being skipped. A plugin conflict had taken the site down for 6 hours in November.",
    solution:
      "We moved the clinic onto our Website Maintenance plan — monthly updates, daily backups, security scanning, uptime monitoring, and a 4-hour response SLA for any issues.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.42 0.19 270) 0%, oklch(0.52 0.17 250) 100%)",
    icon: <Headphones className="w-10 h-10 text-white" />,
    fullDescription:
      "A 12-person law firm in Sydney was frustrated with slow IT support responses from their previous provider. Billing deadlines and court dates meant they couldn't afford tech downtime.",
    challenge:
      "Their previous IT provider had average response times of 6+ hours, and resolution often spilled into the next business day. Staff morale was low and productivity was suffering.",
    solution:
      "We transitioned the firm to our Professional Managed IT plan, assigned a dedicated account manager familiar with legal software requirements, and set up priority escalation protocols for deadline-critical issues.",
    results: [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, oklch(0.50 0.22 320) 0%, oklch(0.60 0.18 345) 100%)",
    icon: <Building2 className="w-10 h-10 text-white" />,
    fullDescription:
      "A growing restaurant group with 3 venues in Melbourne was running different POS systems at each location, had a dated website that didn't reflect their brand, and managed IT reactively.",
    challenge:
      "Inconsistent systems across venues made reporting impossible, inter-venue inventory transfers were manual, and owners had no single view of business performance.",
    solution:
      "We delivered a full Business IT Solutions package: unified cloud POS across all 3 venues, a redesigned website with online reservations, and Managed IT Professional across all locations under one contract.",
    results: [
    ...
    <AnimatedSection delay={index * 70} direction="up">
      ...
      >
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          {/* Headline */}
          <h3 className="font-display font-bold text-foreground text-lg leading-snug mb-4 group-hover:text-primary transition-colors">
            {study.headline}
          </h3>
...
export function PortfolioPage() {
  ...
  const filtered =
    activeFilter === "All"
      ? CASE_STUDIES
      : CASE_STUDIES.filter((c) => c.filter === activeFilter);
  ...
  return (
    <>
      ...
      {/* CTA banner */}
      <section className="py-20 bg-muted/30" data-ocid="portfolio.cta_section">
        <div className="container">
          <AnimatedSection className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Book your free consultation today and let's talk about what's
